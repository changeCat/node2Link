...
function basePageStyles() {
	return `
		...
		*{box-sizing:border-box}body{margin:0;min-width:320px;background:#f5f6f3;color:#17211d}button,input,textarea,select{font:inherit}a{color:inherit}
